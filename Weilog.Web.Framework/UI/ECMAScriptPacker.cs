...
namespace Weilog.Web.Framework.UI
{
    ...
    public class ECMAScriptPacker : IHttpHandler
    {
        ...
        private static readonly string lookup95 = "¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ";
        ...
        private string Escape95(string input)
        {
            ...
            return r.Replace(input, EscapeEval95);
        }

        private string EscapeEval95(Match match)
        {
