...
using Weilog.Core.ComponentModel;
using Weilog.Core.Plugins;
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains("WeilogVersion", StringComparer.InvariantCultureIgnoreCase))
                        {
