...
using Weilog.Core.Domain.Localization;
using Weilog.Core.Domain.Repositories;

namespace Weilog.Services.Localization
{
    /// <summary>
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        public virtual LocaleStringResource GetLocaleStringResourceById(int localeStringResourceId)
        {
            ...
            return _lsrRepository.Get(localeStringResourceId);
        }
        ...
        {
            var query = from lsr in _lsrRepository.Queryable()
        ...
        {
            var query = from l in _lsrRepository.Queryable()
