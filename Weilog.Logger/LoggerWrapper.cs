...
{
    [Serializable]
    public sealed class LoggerWrapper : LoggerWrapperImpl
    {
        ...
        private readonly Type _stackBoundary = typeof(LoggerWrapper);
...
#pragma warning disable 612,618
                while (methodType == _dnnExceptionType || methodType == typeof(LoggerWrapper) || methodType == typeof(LogManager) || methodType == typeof(Control))
#pragma warning restore 612,618
            ...
            {
                _stackBoundary = typeof(LoggerWrapper);
            }
        ...
        private static void ReloadLevels(ILoggerRepository repository)
        {
            ...
            log4net.LogManager.GetRepository().LevelMap.Add(LevelLogInfo);
            log4net.LogManager.GetRepository().LevelMap.Add(LevelLogError);

        }

        public static LoggerWrapper GetClassLogger(Type type)
        {
            return new LoggerWrapper(log4net.LogManager.GetLogger(Assembly.GetCallingAssembly(), type).Logger);
        }

        public static LoggerWrapper GetLogger(string name)
        {
            return new LoggerWrapper(log4net.LogManager.GetLogger(name).Logger);
        }
