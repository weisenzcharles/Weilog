...
zplayer.prototype.init = function() {
    ...
    if(this.option.fixed){
        this.element.classList.insert("zplayer-fixed");
    }
    if (this.option.lrcStart) {
        this.lrc = l(this.musics[0].lrc);
        if(this.option.showLrc){
            this.element.classList.insert("zplayer-withlrc");
        }
        ...
        this.lrcIndex = 0;
        this.lrcContents.getElementsByTagName("p")[0].classList.insert("zplayer-lrc-current");
    }
    ...
    this.audio.addEventListener("ended", function() {
        if(playType==0){
            ...
            if(cur_m != (p.musics.length-1)){
                ...
                p.PauseButton.classList.insert("display-none");
    ...
    if(this.option.lrcStart){
        ...
        this.lrcIcon.addEventListener("click", function() {
            ...
            this.classList.contains("lrc-hide") ? (this.classList.remove("lrc-hide"),p.element.getElementsByClassName("zlrc")[0].style.display="block") : (this.classList.insert("lrc-hide"),p.element.getElementsByClassName("zlrc")[0].style.display="none");
        })
    }
    if(this.option.fixed){
        this.hidePlayerButton.addEventListener("click", function() {
            ...
            p.hidePlayerButton.classList.insert("display-none");
        ...
        this.showPlayerButton.addEventListener("click", function() {
            ...
            p.showPlayerButton.classList.insert("display-none");
    ...
    this.playTypeIcon.addEventListener("click", function() {
        ...
        p.playTypeIcon.classList.insert(playTypes[playType]);
        if(playType==2){
    ...
    function voe(e) {
        ...
        if (i >= 0.8) {
            ...
            p.volumeIcon.classList.insert("z-icon-volume-up")
        } else {
            if (i == 0) {
                p.volumeIcon.classList.remove("z-icon-volume-down", "z-icon-volume-up");
                p.volumeIcon.classList.insert("z-icon-volume-off")
            } else {
                p.volumeIcon.classList.remove("z-icon-volume-off", "z-icon-volume-up");
                p.volumeIcon.classList.insert("z-icon-volume-down")
            }
        }
    ...
    function playSwitch(i) {
        p.PlayButton.classList.insert("display-none");
        ...
        p.element.getElementsByClassName("zplayer-list")[0].getElementsByTagName("li")[i].classList.insert("playing");
        if (p.option.lrcStart) {
            ...
            for (d = 0; d < p.lrc.length; d++) {
                ...
                p.lrcIndex = 0;
                p.lrcContents.getElementsByTagName("p")[0].classList.insert("zplayer-lrc-current");
            }
        }
...
zplayer.prototype.play = function() {
    this.PlayButton.classList.insert("display-none");
...
zplayer.prototype.pause = function() {
    this.PauseButton.classList.insert("display-none");
    ...
    if (e || (e = this.audio.currentTime),
        ...
        for (var a = 0; a < this.lrc.length; a++)
            e >= this.lrc[a][0] && (!this.lrc[a + 1] || e < this.lrc[a + 1][0]) && (this.lrcIndex = a,
                ...
                this.lrcContents.getElementsByTagName("p")[a].classList.insert("zplayer-lrc-current"))
}
